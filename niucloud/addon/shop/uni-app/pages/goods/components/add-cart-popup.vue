		...
		<u-popup :show="goodsSkuPop" @close="closeFn" mode="bottom">
			<view v-if="Object.keys(goodsDetail).length"
				...
				<view class="flex mb-[58rpx]">
					<u--image class="rounded-[8rpx] overflow-hidden" width="204rpx" height="204rpx"
						:src="img(detail.sku_image)" model="aspectFill">
						<template #error>
				...
				<scroll-view class="h-[500rpx]" scroll-y="true">
					...
					<view class="flex justify-between">
						...
						<u-number-box v-else v-model="buyNum" :min="1" :max="detail.stock" integer :step="1"
							...
							<template #minus>
									<text
									class="text-[44rpx] iconfont iconjianhao text-[var(--primary-color)]"
...
import { getGoodsSku } from '@/shop/api/goods';
