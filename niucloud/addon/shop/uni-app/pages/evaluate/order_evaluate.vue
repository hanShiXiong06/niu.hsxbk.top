          ...
          <view class="px-[24rpx] py-[20rpx]">
               <template v-for="(item, index)  in info" :key="index">
                    <view class="bg-white py-[20rpx] px-[24rpx] mb-[20rpx] rounded-[16rpx]">
                         ...
                         <upload-img class="mt-[20rpx]" v-model="form[index].images" :max-count="6" />
                    </view>
               </template>
          </view>
...
import { ref } from 'vue';
import { getShopOrderDetail } from '@/shop/api/order';
import { setOrderEvaluate } from '@/shop/api/evaluate';
import { onLoad } from '@dcloudio/uni-app';
import { img, redirect } from '@/utils/common';
import uploadImg from '@/shop/pages/evaluate/components/upload-img'
...
const toLink = (order_id: any) => {
     redirect({ url: '/shop/pages/evaluate/order_evaluate_view', param: { order_id }, mode: 'redirectTo' })
}
</script>
