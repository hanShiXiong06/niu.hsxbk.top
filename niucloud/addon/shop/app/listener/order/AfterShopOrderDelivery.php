...
class AfterShopOrderDelivery
{
    ...
    public function handle($data){
        ...
        //消息发送
        (new NoticeService())->send('shop_order_delivery', ['order_id' => $data['order_id'] ]);
...
//                OrderFinish::invoke(['order_id' => $order_data['order_id'] ], secs: $order_config['finish_length'] * 86400);
            }
        }
    }
}
