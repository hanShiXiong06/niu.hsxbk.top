...
trait CoreOrderCreateTrait
{
    ...
    public function createOrder(array $data)
    {
        ...
        try {
            ...
            //订单创建后事件
            event('AfterShopOrderCreate', ['order_id' => $this->order_id, 'order_data' => $order_data, 'goods_goods_data' => $order_goods_data, 'cart_ids' => $this->cart_ids, 'basic' => get_object_vars($this), 'main_type' => $main_type, 'main_id' => $main_id, 'time' => time()]);
            //订单金额为0的话,要直接支付
