 ...
 */
class CoreOrderConfigService extends BaseAdminService
{
    //系统配置文件
    ...
    public function getConfig()
    {
        ...
        //发票
        $data['invoice'] = (new CoreConfigService())->getConfigValue($invoice);
        ...
        //评价
        $data['evaluate'] = (new CoreConfigService())->getConfigValue($invoice);
