		...
		<el-card class="box-card !border-none" shadow="never">
			...
			<el-card class="box-card !border-none my-[10px] table-search-wrap" shadow="never">
				<el-form :inline="true" :model="shopAddressTable.searchParam" ref="searchFormRef">
					...
					<el-form-item :label="t('fullAddress')" prop="full_address">
						<el-input v-model="shopAddressTable.searchParam.full_address"
			...
			<div class="mt-[10px]">
				<el-table :data="shopAddressTable.data" size="large" v-loading="shopAddressTable.loading">
					...
					<el-table-column prop="full_address" :label="t('fullAddress')" min-width="120"
					                 :show-overflow-tooltip="true"/>
					<el-table-column prop="is_delivery_address" :label="t('addressType')" min-width="120"
					                 align="left">
...
<script lang="ts" setup>
    ...
    import {t} from '@/lang'
    import {getShopAddressList, deleteShopAddress} from '@/shop/api/shop_address'
