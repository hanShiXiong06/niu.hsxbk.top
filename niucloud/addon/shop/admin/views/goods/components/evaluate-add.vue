<template>
    <el-dialog v-model="showDialog" :title="formData.evaluate_id ? t('updateEvaluate') : t('addEvaluate')" width="700px" class="diy-dialog-wrap"
...
import { addEvaluate } from '@/shop/api/goods'
