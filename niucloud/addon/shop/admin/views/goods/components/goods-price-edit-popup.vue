<template>
	<div>
		<el-dialog v-model="showDialog" :title="t('editPricePopupTitle')" width="800px"
			...
			<div class="batch-operation-sku" v-if="goodsTable.data.length>1">
				...
				<div v-if="batchOperation.field">
					<el-input v-model="batchOperation.value" clearable
					          :placeholder="t(batchOperation.field)" class="set-input"
					          maxlength="20"
					          :autofocus="true"
					/>
			...
			<el-table :data="goodsTable.data" size="large" v-loading="goodsTable.loading" max-height="400">
				...
				<el-table-column prop="price" :label="t('price')" min-width="120">
					<template #default="{ row }">
						<el-input v-model="row.price" clearable
						          placeholder="0.00"
						          maxlength="10"
						          type="number"
						/>
				...
				<el-table-column prop="market_price" :label="t('marketPrice')" min-width="120">
					<template #default="{ row }">
						<el-input v-model="row.market_price" clearable
						          placeholder="0.00"
						          maxlength="10"
						          type="number"
						/>
				...
				<el-table-column prop="cost_price" :label="t('costPrice')" min-width="120">
					<template #default="{ row }">
						<el-input v-model="row.cost_price" clearable
						          placeholder="0.00"
						          maxlength="10"
						          type="number"
						/>
