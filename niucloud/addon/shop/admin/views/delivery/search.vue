            ...
            <el-card class="box-card !border-none" shadow="never">
                <el-form-item :label="t('interfaceType')" prop="interface_type" class="">
					<div >
						...
						<p class="text-[12px] text-[#b2b2b2]" v-if="formData.interface_type == 2">{{ t('promptTips2') }}<el-button class="button-size" type="primary" link @click="kdnEvent">https://www.kuaidi100.com/</el-button></p>
					</div>
                </el-form-item>
...
import { setDeliverySearch, getDeliverySearch } from '@/shop/api/delivery'
