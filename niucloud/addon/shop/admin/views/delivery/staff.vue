...
import { t } from '@/lang'
import deliveryPersonnelEdit from '@/shop/views/delivery/components/delivery-personnel-edit.vue'
import { getShopDelivery, deleteShopDeliver } from '@/shop/api/delivery'
