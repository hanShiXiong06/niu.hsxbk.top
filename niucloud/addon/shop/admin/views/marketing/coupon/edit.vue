		...
		<el-card class="box-card !border-none page-height" shadow="never" v-if="Object.keys(formData).length">
			<el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form">
				...
				<el-form-item :label="t('price')" prop="price">
					<el-input type="number" οninput="value=value.replace(/[^\d.]/g,'')" v-model="formData.price"
					          clearable :placeholder="t('pricePlaceholder')" class="input-width" maxlength="60"/>
				</el-form-item>
...
<script lang="ts" setup>
    ...
    import {getGoodsCategoryList, editCoupon, getCouponInfo} from '@/shop/api/marketing';
