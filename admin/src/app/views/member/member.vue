        ...
        <el-card class="box-card !border-none" shadow="never">
            ...
            <el-card class="box-card !border-none my-[10px] table-search-wrap" shadow="never">
                <el-form :inline="true" :model="memberTableData.searchParam" ref="searchFormRef">
                    ...
                    <el-form-item :label="t('status')" prop="status">
                        <el-select v-model="memberTableData.searchParam.status" placeholder="Select">
                            <el-option label="全部" value="1" />
                            <el-option :label="t('normal')" value="2" />
                            <el-option :label="t('lock')" value="3" />
                        </el-select>
                    </el-form-item>
            ...
            <div class="mt-[10px]">
                <el-table :data="memberTableData.data" size="large" v-loading="memberTableData.loading">
                    ...
                    <el-table-column prop="member_no" :label="t('memberNo')" min-width="130" />
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="flex flex flex-col">
                                    ...
                                    <span v-if="row.status != 1">
                                        ...
                                        <el-tag type="error"  @click="lockMember(row, 1)" class="cursor-pointer">{{t('lock')}}</el-tag>
                                    </span>
                    ...
                    <el-table-column :label="t('operation')" fixed="right" align="right" min-width="120">
                        <template #default="{ row }">
                            <div class="">
                                <el-button type="primary" link @click="detailEvent(row)" align="right">{{ t('detail') }}</el-button>
                                <el-button type="primary" link @click="setMemberLable(row)" align="right">{{ t('setLable') }}</el-button>
                                <el-button v-if="row.status == 1" type="primary"  @click="lockMember(row, 0)" link  align="right">冻结</el-button>
                                <el-button v-else type="primary"  @click="lockMember(row, 1)" link  align="right">启用</el-button>
                            </div>
                        </template>
                    </el-table-column>
