           ...
           <div>
                ...
                <div class="mt-[16px] flex justify-end">
                    <el-pagination v-model:current-page="invoiceManagementTableData.page"
                        v-model:page-size="invoiceManagementTableData.limit" layout="total, sizes, prev, pager, next, jumper"
                        :total="invoiceManagementTableData.total" @size-change="loadInvoiceList()"
...
import { t } from '@/lang'
import { getInvoiceList} from '@/shop/api/order'
import { FormInstance } from 'element-plus'
import InvoiceDetail from '@/shop/views/order/components/invoice-detail.vue'
import InvoiceDialog from '@/shop/views/order/components/invoice-dialog.vue'
