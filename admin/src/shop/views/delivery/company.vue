			...
			<el-card class="box-card !border-none my-[10px] table-search-wrap" shadow="never">
				<el-form :inline="true" :model="companyTable.searchParam" ref="searchFormRef">
					<el-form-item :label="t('companyName')" prop="company_name">
						<el-input v-model="companyTable.searchParam.company_name"
...
<script lang="ts" setup>
    ...
    import {t} from '@/lang'
    import {getCompanyList, deleteCompany} from '@/shop/api/delivery'
    import {img} from '@/utils/common'
    import {ElMessageBox} from 'element-plus'
    import CompanyEdit from '@/shop/views/delivery/components/company-edit.vue'
