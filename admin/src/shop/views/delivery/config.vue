<template>
	<div class="main-container" v-loading="loading">
		...
		<div class="p-[18px] logistics-body" ref="tableRef" :key="toggleIndex">
						...
						<template #header>
							<div class="flex items-center justify-between">
								<div class="flex items-center">
									<i class="iconfont icontuodong vues-rank !cursor-move mr-[5px]"></i>
									<el-input v-focus v-if="index === activeIndex" v-model="inputValue"
									          class="w-[120px]"
									          @blur="inputBlur"/>
...
<script lang="ts" setup>
    ...
    import {getShopDeliveryList, setShopDeliveryConfig} from '@/shop/api/delivery'
