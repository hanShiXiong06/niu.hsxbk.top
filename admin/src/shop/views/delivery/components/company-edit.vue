<template>
	<el-dialog v-model="showDialog" :title="formData.company_id ? t('updateCompany') : t('addCompany')" width="500px"
	           class="diy-dialog-wrap" :destroy-on-close="true">
		<el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form"
		         v-loading="loading">
			<el-form-item :label="t('companyName')" prop="company_name">
				<el-input v-model="formData.company_name" clearable :placeholder="t('companyNamePlaceholder')"
				          class="input-width"/>
			</el-form-item>
			...
			<el-form-item :label="t('expressNo')">
				<div>
					<el-input v-model="formData.express_no" clearable :placeholder="t('expressNoPlaceholder')"
					          class="input-width"/>
...
<script lang="ts" setup>
    ...
    import {addCompany, editCompany, getCompanyInfo} from '@/shop/api/delivery'
