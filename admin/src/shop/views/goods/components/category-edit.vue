        ...
        <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form"
            ...
            <el-form-item :label="t('pid')" prop="pid">
                <el-select v-model="formData.pid" clearable :disabled="!!formData.child_count" placeholder="Select" class="input-width">
                    ...
                    <el-option v-for="(item, index) in optionList" :key="item.category_id" :label="item.category_name"
...
import { addCategory, editCategory, getCategoryInfo, getCategoryList } from '@/shop/api/goods'
...
const getCategoryAllFn = () => {
    getCategoryList({
        ...
        optionList.value = res.data.filter(el => el.category_id != formData.category_id)
    })
}
