								...
								<el-image class="w-[30px] h-[30px] " :src="img(row.logo)" fit="contain">
									<template #error>
										<div class="image-slot">
											<img class="w-[30px] h-[30px]" src="@/shop/assets/brand_default.png"/>
										</div>
									</template>
								</el-image>
							</div>
...
<script lang="ts" setup>
    ...
    import {t} from '@/lang'
    import {getBrandPageList, deleteBrand} from '@/shop/api/goods'
    import {img} from '@/utils/common'
    import {ElMessageBox} from 'element-plus'
    import BrandEdit from '@/shop/views/goods/components/brand-edit.vue'
