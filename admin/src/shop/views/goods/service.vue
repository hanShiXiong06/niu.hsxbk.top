...
<!--							                &lt;!&ndash; <img class="w-[30px] h-[30px]" src="@/shop/assets/category_default.png" /> &ndash;&gt;-->
<!--							            </div>-->
<!--							        </template>-->
<!--							    </el-image>-->
<!--							</div>-->
...
import { t } from '@/lang'
import { getServePageList, deleteServe } from '@/shop/api/goods'
import { img } from '@/utils/common'
import { ElMessageBox } from 'element-plus'
import ServiceEdit from '@/shop/views/goods/components/service-edit.vue'
