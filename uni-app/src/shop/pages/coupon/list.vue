						...
						<view class="h-[222rpx] flex flex-1 flex-wrap pt-[24rpx] box-border ml-[19rpx] mr-[9rpx]">
							<view class="text-[27rpx] text-[#303133] leading-[38rpx] w-[100%]">
								...
								<view class="flex mt-[5rpx]">
									<text class="flex items-center bg-[#93979D] text-[#fff] text-[20rpx] h-[32rpx] px-[16rpx] rounded-[16rpx]">{{ item.type_name }}</text>
								</view>
							</view>
							<view
					...
					<view v-else class ="flex items-center relative w-[100%] rounded-[16rpx] overflow-hidden bg-[#FFF4F4]"
						...
						<view class="h-[222rpx] flex flex-1 flex-wrap pt-[24rpx] box-border ml-[19rpx] mr-[9rpx]">
							<view class="text-[27rpx] text-[#303133] leading-[38rpx] w-[100%]">
								<view>{{ item.title }}</view>
								<view class="flex mt-[5rpx]">
									<text class="flex items-center bg-[#FF4646] text-[#fff] text-[20rpx] h-[32rpx] px-[16rpx] rounded-[16rpx]">{{ item.type_name }}</text>
								</view>
							</view>
							<view
...
const toDetail = (id: any) => {
	redirect({ url: '/shop/pages/coupon/detail', param: { coupon_id: id } })
}
const toLink = (id: any) => {
