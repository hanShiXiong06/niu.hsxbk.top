		...
		<u-popup :show="goodsSkuPop" @close="closeFn" mode="bottom">
			<view class="rounded-t-[20rpx] overflow-hidden bg-[#fff] p-[32rpx] relative">
				...
				<view class="flex mb-[58rpx]">
					<u--image class="rounded-[8rpx] overflow-hidden" width="204rpx" height="204rpx" :src="img(goodsDetail.detail.sku_image)"
						model="aspectFill">
						<template #error>
				...
				<scroll-view class="h-[500rpx]" scroll-y="true">
					<view class="mb-[50rpx]" v-for="(item,index) in goodsDetail.goodsSpec" :key="index">
						...
						<view class="flex flex-wrap">
							<view
							class="box-border  min-w-[96rpx] text-[24rpx] px-[15rpx] text-center h-[52rpx] leading-[52rpx] mr-[20rpx] border-1 border-solid rounded-[8rpx] border-[#888]"
