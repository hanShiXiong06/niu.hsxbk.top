<template>
	<view :style="warpCss" class="overflow-hidden flex items-center pl-[24rpx]">
		<image :src="img('addon/shop/diy/search_01.png')" class="w-[40rpx] h-[40rpx]" mode="widthFix" @click="toLink('/shop/pages/goods/category')"></image>
		<view class="flex-1 ml-[24rpx] rounded-[32rpx] flex items-center bg-[#F7F8FD] opacity-90 py-[18rpx] pl-[38rpx] pr-[32rpx] justify-between" @click="toLink('/shop/pages/goods/list')">
